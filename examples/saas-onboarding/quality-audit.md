...
| Experience integrity | 1 | No invented emotion, and "not researched" is written where true. Expectations were researched only at stages 2–3, and `MET-0006` does not exist yet | observed | `EVD-2026-0006` | Decisions about trust rest on stated intent until `INI-0002` reports | Expectation probes in the next round; ship `MET-0006` with the randomized rollout | `customer-journey-mapping` |
