...
| Initiatives | `initiative-register.csv` | this skill | `initiative_id,opportunity_ids,hypothesis,change,expected_metric_ids,expected_effect,dependencies,owner,status` |
