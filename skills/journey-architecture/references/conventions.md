...
|---|---|---|---|
| Actors | `actor-register.csv` | this skill | `actor_id,name,actor_type,segment,context` |
| Journeys | `journey-registry.csv` | this skill | `journey_id,level,parent_id,actor_id,name,trigger,start_boundary,end_boundary,desired_outcome,state,baseline_journey_id,status,owner,version,last_reviewed_at` |
| Relations | `relation-register.csv` | this skill | `from_id,relation,to_id,evidence_ids,evidence_status,note` |
| Nodes | `node-register.csv` | this skill | `node_id,journey_id,parent_node_id,node_type,sequence,name,actor_goal,evidence_ids,evidence_status` |
...
| Metric edges | `metric-edge-register.csv` | `journey-metrics` skill | `from_metric_id,relation,to_metric_id,evidence_ids,evidence_status,note` |
...
| Portfolio | `portfolio-register.csv` | `journey-portfolio-management` skill | `journey_id,parent_id,level,actor_id,name,state,status,owner,evidence_freshness,metric_coverage,linked_opportunities,linked_initiatives,last_reviewed_at` |
...
| Change log | `change-log.csv` | `journey-governance` skill | `change_id,journey_id,changed_at,version,change,reason,evidence_ids,affected_node_ids,approved_by` |
