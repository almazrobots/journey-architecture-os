...
| Governance | `governance-register.csv` | this skill | `journey_id,owner,evidence_steward,metric_owners,review_interval_days,last_reviewed_at,next_review_due,review_triggers,freshness_rule` |
| Change log | `change-log.csv` | this skill | `change_id,journey_id,changed_at,version,change,reason,evidence_ids,affected_node_ids,approved_by` |
