...
| Metrics | `metric-register.csv` | this skill | `metric_id,journey_or_node_id,layer,name,definition,unit,source,population,cadence,owner,direction,baseline,target,evidence_ids,evidence_status` |
| Metric edges | `metric-edge-register.csv` | this skill | `from_metric_id,relation,to_metric_id,evidence_ids,evidence_status,note` |
